...
// manager routes    
Route::post('/managers/register', [ManagerController::class, 'RegisterManager']); // tested
Route::post('/managers/login', [ManagerController::class, 'LoginManager']); // tested

Route::middleware('auth:sanctum')->group(function (): void {
    // Manager routes
    Route::get('managers/{id}', [ManagerController::class, 'getManagerById']); // tested 
    Route::put('/managers/update/{id}', [ManagerController::class, 'updateManager']); // tested
